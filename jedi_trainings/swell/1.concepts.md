...
## Suites, suite configurations, and experiments
 ...
 A suite is a predefined workflow that describes the tasks required to perform a particular operation or experiment. 
...
contains suites for workflows such as 3D-Var, HofX, and data ingestion. Each
